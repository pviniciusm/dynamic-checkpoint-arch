...
class Agente(object):
	...
	def take_results(self, component):
		while True:
	...
	def ramtimes(self):
		...
		a_ram = t_ram.percent
		hourss = str(datetime.datetime.now().year)+"/"+str(datetime.datetime.now().month)+"/"+str(datetime.datetime.now().day)
		hourss = hourss+"  "+str(datetime.datetime.now().hour)+":"+str(datetime.datetime.now().minute)+":"+str(datetime.datetime.now().second)
		print(hourss+" - RAM: "+str(a_ram))
